...
## Lernziele
1. [Sie können die Funkionen eines Routers erläutern](##LZ1:-Sie-können-die-Funkionen-eines-Routers-erläutern)
2. [Sie können den Vorgang der Neuadresssierung eines Frames im Router erläutern](LZ2:-Sie-können-den-Vorgang-der-Neuadresssierung-eines-Frames-im-Router-erläutern)
